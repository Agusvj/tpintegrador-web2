...
export class ProductCard extends LitElement {
  ...
  render() {
    return html`
      <div
        class="sm:h-[480px] h-[300px] grid grid-cols-2 sm:grid-cols-1 gap-4 rounded-xl bg-white shadow-md p-4 hover:shadow-lg transition"
      >
        <div
          class="sm:h-[200px] h-[300px] overflow-hidden flex items-center justify-center py-6"
        >
